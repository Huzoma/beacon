...
export default function Hero() {
  return (
    <section className="bg-black">
      ...
      <MaxWidthContainer>
        <div className="text-white flex flex-col md:flex-row md:justify-between items-center text-center md:text-left py-10 md:py-20 gap-10 md:gap-0">
          ...
          <div className="w-full max-w-lg mx-auto md:mx-0 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 w-full items-center  justify-center md:justify-start">
              <Link href="/jobs">
                <Button text="Find Jobs">Find Jobs</Button>
              </Link>
