...
const faqData = [
  {
    id: 1,
    question: 'What makes Beacon different from other job boards?',
    answer:
      'Beacon focuses intensely on quality and reliability. We manually curate our listings, emphasizing clarity and cutting out the noise. Our modern, developer-friendly stack ensures a fast, responsive, and trustworthy experience.',
  },
  {
    id: 2,
    question: 'Is Beacon free for job seekers?',
    answer:
      'Yes, our platform is completely free for job seekers. You can browse, apply, and manage your career profile without any cost.',
  },
  {
    id: 3,
    question: 'How can I post a job opening for my company?',
    answer:
      "To post a job, simply click the 'Job Post' button in the navigation bar. You will be guided through a quick, transparent, and employer-focused process to list your opening.",
  },
  {
    id: 4,
    question: 'What technologies power the Beacon platform?',
    answer:
      'Built by developers for developers, Beacon utilizes a modern, performance-focused stack including Next.js, React, and Tailwind CSS for a seamless, fast, and secure user experience.',
  },
];
// ----------------------------------------------------------------------
