// Archived copy of the old jobs/[id]/page.jsx
// This file was moved to [slug] route which now supports slug and id.
...
export default function ArchivedJobDetailsPage({ params }) {
  // This is an archived copy kept for reference.
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a0f1a] to-black text-white p-8 md:p-16">
      <MaxWidthContainer>
        <Link href="/jobs" className="text-blue-400 hover:underline mb-8 block">
          &larr; Back to Job Listings
        </Link>

        <div className="bg-white/5 border border-[#1E90FF]/20 backdrop-blur-xl transition p-8 rounded-xl shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {job.longDesc &&
              Object.entries(job.longDesc).map(([section, items]) => (
                <div
                  key={section}
                  className="bg-[#1E90FF]/20 border border-[#1E90FF]/40 p-6 rounded-lg"
                >
