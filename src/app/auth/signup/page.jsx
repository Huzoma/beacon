        ...
        <div className="w-full lg:w-1/2 p-10 flex flex-col justify-center text-white">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                variant="outline"
                className="w-full flex justify-center items-center border-white/20 text-blue-500 bg-white/5 hover:bg-white/10 rounded-xl transition-all p-3.5 font-semibold"
              ...
              <button
                variant="outline"
                className="w-full flex justify-center items-center border-white/20 text-blue-500 bg-white/5 hover:bg-white/10 rounded-xl transition-all p-4 font-semibold"
